...
import type { Model, FixResponse } from '@/types/actions'
...
export const FixPage = () => {
  ...
  const { data, loading, error: apiError, execute, reset } = useCodeAction()

  const result = data as FixResponse | null
  ...
  return (
    <div className="flex-1 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Bug Fix</h1>
        <p className="text-slate-600 mb-8">
          Identify and fix bugs in your code with AI assistance.
        </p>
            ...
            {result && !loading && (
              <>
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <CodeOutput code={result.fixed_code} language="python" />
                </div>
            ...
            {loading && (
              <div className="bg-white rounded-lg shadow p-6 flex items-center justify-center min-h-64">
                <div className="text-center">
                  <LoadingSpinner />
                  <p className="mt-4 text-slate-600">Analyzing and fixing...</p>
                </div>
              </div>
            )}
          </div>
