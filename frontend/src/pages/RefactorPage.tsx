...
import type { Model, RefactorResponse } from '@/types/actions'
...
export const RefactorPage = () => {
  ...
  const result = data as RefactorResponse | null

  const handleRefactor = async () => {
    if (!code.trim() || !requirements.trim()) {
      return
    }
    await execute({
      action: 'refactor',
  ...
  return (
    <div className="flex-1 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Refactor Code</h1>
        <p className="text-slate-600 mb-8">
          Improve your code with AI-powered refactoring suggestions.
        </p>
            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g., Add type hints, improve performance, increase readability..."
                  className="w-full h-24 p-4 border border-slate-300 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none"
                />
              </div>
              ...
              <button
                ...
                disabled={loading || !code.trim() || !requirements.trim()}
            ...
            {result && !loading && (
              <>
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <CodeOutput code={result.refactored_code} language="python" />
                </div>
            ...
            {loading && (
              <div className="bg-white rounded-lg shadow p-6 flex items-center justify-center min-h-64">
                <div className="text-center">
                  <LoadingSpinner />
                  <p className="mt-4 text-slate-600">Refactoring code...</p>
                </div>
              </div>
            )}
          </div>
